...
{
    public class BlackListedDomainsCheck
    {
        private readonly IMemoryCache _cache;
        private const string CacheKey = "BlackListedDomains";
        private const string FilePath = "blacklistedDomains.txt";

        private static readonly object CacheLock = new();

        public BlackListedDomainsCheck(IMemoryCache memoryCache)
        {
            _cache = memoryCache;
            LoadDomains();
        }
        ...
        public async Task<bool?> IsBlackListedDomain(string domain)
        {
            try
            {
